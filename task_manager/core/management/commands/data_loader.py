    ...
    data = [
        {
            ...
            'model': 'tasks.Difficulty',
            'fields': ['name', 'slug'],
            'type': 'json'
        },
        {
            'file_name': 'priority',
            'model': 'tasks.Priority',
            'fields': ['name', 'slug'],
            'type': 'json'
        },
        {
            'file_name': 'recurrence',
            'model': 'tasks.Recurrence',
            'fields': ['name', 'slug'],
            'type': 'json'
        },
        {
        ...
        {
            'file_name': 'status_transition',
            'model': 'tasks.StatusTransition',
            'fields': ['current_status', 'next_status'],
            'type': 'json'
        }
